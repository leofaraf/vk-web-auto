import { ADD_COVERAGE_URL, CHECK_URL, UPLOAD_INPUT } from "@/lib/constants";
    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button variant={"outline"} className="w-full">Обновить input.csv</Button>
            </DialogTrigger>
            <DialogContent>
                <DialogHeader>
                <DialogTitle>Обновить input.csv</DialogTitle>
                <DialogDescription>
