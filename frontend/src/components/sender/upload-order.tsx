import { ADD_COVERAGE_URL, CHECK_URL, UPLOAD_ORDER } from "@/lib/constants";
    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button variant={"outline"} className="w-full">Обновить order.txt</Button>
            </DialogTrigger>
            <DialogContent>
                <DialogHeader>
                <DialogTitle>order.txt</DialogTitle>
                <DialogDescription>
